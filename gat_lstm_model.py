...
class GAT_LSTM(nn.Module):
    def __init__(self, node_feature_dim, sequence_feature_dim, gat_out_channels, gat_heads, lstm_hidden_dim, lstm_layers, edge_dim):
        ...
        # self.gat_1hop_3 = GATConv(node_feature_dim, gat_out_channels, heads=gat_heads, concat=False,
    ...
    def forward(self, sequences, edge_index, edge_attr, node_features, node_indices):
        ...
        # gat_1hop_out_3 = self.gat_1hop_3(node_features, edge_index, transformed_edge_attr)
        # gat_1hop_out_3 = self.gat_dropout(gat_1hop_out_3)
        # gat_1hop_out_3 = gat_1hop_out_3[node_indices]
        ...
        # gat_combined_out = torch.cat((gat_1hop_out_1, gat_1hop_out_2,gat_1hop_out_3), dim=-1)  # [batch_size, 3 * gat_out_channels]
